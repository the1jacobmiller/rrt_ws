...
private:
  ...
  ros::Publisher lidar_obstacles_pub;
  ...
  void copyObjectsToApolloLidarFrame(const autoware_msgs::DetectedObjectArray objects,
    apollo::perception::lidar::LidarFrame* frame);

  void publishBoundingBoxes(std::vector<std::shared_ptr<apollo::perception::base::Object>> tracked_objects);
